        ...
        <?php if (have_posts()) : ?>
            ...
            <?php while (have_posts()) : the_post(); ?>
            	...
            	<div class="archive_post_block">
            		...
            		<div class="archive_post_meta"><?php clean_authors(get_post_custom_values('Written by:')); clean_additional(get_post_custom_values('Additional reporting by:')); ?> <!--By <?php the_author_posts_link(); ?>--> <span class="dot">&sdot;</span> <?php the_time('F j, Y'); ?> <span class="dot">&sdot;</span> <a href="<?php comments_link(); ?>"><?php comments_number('Post a comment','One comment','% comments'); ?></a></div>
