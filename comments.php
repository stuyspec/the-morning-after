<?php // Do not delete these lines
	if ('comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
		die ('No no, please do not load this page directly. Thanks!');
...
<fieldset>
	...
	<p>
		...
		<input class="comtext" type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" /> <small>Your email will not be published.</small>
	</p>
